        ...
        <main class="py-4">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5 shadow pt-4 justify-content-center" id="registerpage">
                        <div class="row justify-content-center">
                        ...
                        <form action="{{ route('register') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label for="username" class="col-md-4 col-form-label text-md-right">Username / ID</label>
                                <div class="col-md-7">
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-md-12 offset-md-4 mb-4">
                                    <a href="{{ route('login') }}" class="btn btn-outline-info btn-md">Sudah Punya Akun?</a>
                                </div>
                            </div>
                        </form>
                    </div>
